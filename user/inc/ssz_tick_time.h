...
int32_t ssz_tick_time_now(void);
//return the str according SSZ_TIME_STR_FORMAT_WHEN_PRINT
const char* ssz_tick_time_now_str(void);
...
int ssz_tick_time_get_new_tick_flag(void);

//clear new tick flag
void ssz_tick_time_clear_new_tick_flag(void);
